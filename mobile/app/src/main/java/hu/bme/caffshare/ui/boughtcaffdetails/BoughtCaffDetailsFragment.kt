...
import kotlinx.android.synthetic.main.fragment_bought_caff_details.*

class BoughtCaffDetailsFragment :
    RainbowCakeFragment<BoughtCaffDetailsViewState, BoughtCaffDetailsViewModel> {

    override fun provideViewModel() = getViewModelFromFactory()
    override fun getViewResource() = R.layout.fragment_bought_caff_details
    ...
    override fun onEvent(event: OneShotEvent) {
        when (event) {
            is BoughtCaffDetailsViewModel.DownloadSuccessful -> {
                showSuccessSnackBar("Successful donwload!")
